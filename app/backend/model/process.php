...
$regiao = filter_input(INPUT_POST, 'regiao', FILTER_SANITIZE_STRING);
 ...
 $resultado_cadastro_cliente = "INSERT INTO cliente (email, senha, Primeiro_Nome, Ultimo_Nome, Cidade, CPF, regiao)  VALUES('$email', '$senha', '$Primeiro_Nome', '$Ultimo_Nome', '$Cidade', '$CPF', '$regiao')";
