...
<div class="card rounded-3 border-warning shadow-lg mb-3 position-absolute top-100 start-50 translate-middle" style="max-width: 30rem;">
...
?><br><?php
echo "Telefone Fixo: ". $_SESSION['clienteFixo'];
?><br><?php
echo "Horas de treino: ". $_SESSION['clienteNivel'];
?>
